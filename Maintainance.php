...
<section id="content-area">
	<div class="heading" >
			...
			<p style="padding-top:5px;font-size:15px; color:#7D0552;border-top: 2px solid #7D0552;">File a Maintenance request to send it to your building owner!</p>
	</div>
	<div class="container">
		<form>
			<div class="row">
				<div class="col-25">
					<label for="fname">Maintenance Type</label>
				</div>
				<div class="col-75">
					<select name="cars" id="cars" class="dropdown">
					 ...
					 $sql = "SELECT type FROM ppw1112_youareondefault.Maintenance";
	...
	?>
			...
			<div class="row">
				<div class="col-25">
					<label for="fname">Maintenance Area</label>
				</div>
				<div class="col-75">
					<select name="cars" id="cars" class="dropdown">
					...
					// Create connection
					$conn = new mysqli($servername, $username, $password,$dbname);
					$sql = "SELECT area FROM ppw1112_youareondefault.Maintenance";
					$result = mysqli_query($conn, $sql) or die('error getting data');
					while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
			...
			<div class="row">
 				<div class="col-25">
 					<label for="fname">Describe the issue</label>
 				</div>
 				<div class="col-75">
 					<textarea class="dropdown" id="subject" name="subject" placeholder="Write something.." style="height:150px;width:300px;"></textarea>
 				</div>
 			</div>
			<div class="row">
				<div class="col-25">
